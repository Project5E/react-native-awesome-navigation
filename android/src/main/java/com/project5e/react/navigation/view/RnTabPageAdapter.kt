...
import com.project5e.react.navigation.data.react.Component

class RnTabPageAdapter(fm: FragmentManager, private val children: List<Component>) :
    ...
    override fun getItem(position: Int): Fragment = RnFragment().apply {
        arguments = Bundle().apply {
            putString(ARG_COMPONENT_NAME, children[position].name)
        }
    }
